const Hero = () => {
  return (
    <div className="w-full min-h-[75vh] h-screen grid grid-cols-1j justify-center md:grid-cols-2 gap-5 items-center px-4 md:px-16 lg:px-[20%]">
      <div>
      ...
      <div>
        <img
          className="w-[200px] md:w-[400px]lg:w-full"
